    ...
    <BaseView>
        <div slot="right-section">
            ...
            <header class="mt-4 border-b border-slate-300 pb-2">
                <h3 class="text-sm md:text-xl font-normal tracking-wider">Editar Cuenta</h3>
            </header>

            <form @submit.prevent="updateUser(user)" id="form" class="flex flex-col mt-8">
                <label class="mb-1" for="first-name">Nombre</label>
                <input class="mb-5 px-2 py-2" v-model="user.firstName" id="first-name" type="text" placeholder="Ingresar Nombre" required>
                <label class="mb-1" for="last-name">Apellido</label>
                <input class="mb-5 px-2 py-2" v-model="user.lastName" id="last-name" type="text" placeholder="Ingresar Apellido" required>
                <label class="mb-1" for="email">Email</label>
                <input class="mb-5 px-2 py-2" v-model="user.email" type="email" name="email" id="email" placeholder="Ingresar Email" disabled>
                <label class="mb-1" for="email">Contraseña</label>
                <div class="relative">
                    ...
                    <div class="absolute inset-y-0 right-3 flex items-center text-sm leading-5">
                        <svg class="tracking-wider cursor-pointer" @click.prevent="show = !show" v-show="show" xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 576 512">
                <path d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z"/></svg>
                        <svg class="tracking-wider cursor-pointer" @click.prevent="show = !show" v-show="!show" xmlns="http://www.w3.org/2000/svg" height="1.5em" viewBox="0 0 640 512">
                ...
                <div class="flex justify-start items-center mt-5">
                    <button class="bg-slate-900 text-white px-5 py-2 rounded hover:shadow-xl text-center">
                        <p v-show="!isLoading">Actualizar</p>
                    ...
                    <router-link class="ml-3 justify-end hover:underline" to="/">Cancelar</router-link>
                </div>
            </form>
        </div>
    </BaseView>
