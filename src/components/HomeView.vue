<template>
    <BaseView>
        <div slot="right-section">
            ...
            <header class="mt-4">
                <h2 class="text-gray-700 text-4xl md:text-6xl font-semibold leading-none tracking-wider">Hola, {{ account.firstName }}</h2>
                <h3 class="text-sm md:text-xl font-normal tracking-wider">Registro de inicio de sesión simple</h3>
            </header>

            <div>
                <h4 class="font-bold pb-2 mt-12 border-b border-slate-300">Lista de Usuario</h4>
                <div class="mt-4">
                    <ul>
